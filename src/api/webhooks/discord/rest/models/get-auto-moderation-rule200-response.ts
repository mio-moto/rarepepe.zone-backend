...
/**
 * @type GetAutoModerationRule200Response
 * @export
 */
export type GetAutoModerationRule200Response = DefaultKeywordRuleResponse | KeywordRuleResponse | MLSpamRuleResponse | MentionSpamRuleResponse | SpamLinkRuleResponse;
