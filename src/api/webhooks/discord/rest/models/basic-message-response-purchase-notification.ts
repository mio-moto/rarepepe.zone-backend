...
// @ts-ignore
import { PurchaseNotificationResponse } from './purchase-notification-response';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * @export
 */
export type BasicMessageResponsePurchaseNotification = PurchaseNotificationResponse | any;
