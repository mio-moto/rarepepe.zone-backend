...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        bulkUpdateGuildRoles: async (
            ...
            const localVarPath = `/guilds/{guild_id}/roles`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        createGuildEmoji: async (
            ...
            const localVarPath = `/guilds/{guild_id}/emojis`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        deleteChannel: async (channelId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/channels/{channel_id}`.replace(
                `{${"channel_id"}}`,
                encodeURIComponent(String(channelId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        deleteWebhook: async (webhookId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/webhooks/{webhook_id}`.replace(
                `{${"webhook_id"}}`,
        ...
        getGuildPreview: async (guildId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/guilds/{guild_id}/preview`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        getGuildWidgetSettings: async (guildId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/guilds/{guild_id}/widget`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        getSticker: async (stickerId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/stickers/{sticker_id}`.replace(
                `{${"sticker_id"}}`,
                encodeURIComponent(String(stickerId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        listGuildBans: async (
            ...
            const localVarPath = `/guilds/{guild_id}/bans`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        listGuildInvites: async (guildId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/guilds/{guild_id}/invites`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        listGuildMembers: async (
            ...
            const localVarPath = `/guilds/{guild_id}/members`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        listGuildVoiceRegions: async (guildId: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/guilds/{guild_id}/regions`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        listPrivateArchivedThreads: async (
            ...
            if (before !== undefined) {
                localVarQueryParameter["before"] =
                    (before as any) instanceof Date ? (before as any).toISOString() : before;
            }
        ...
        previewPruneGuild: async (
            ...
            const localVarPath = `/guilds/{guild_id}/prune`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        setGuildMfaLevel: async (
            ...
            const localVarPath = `/guilds/{guild_id}/mfa`.replace(
                `{${"guild_id"}}`,
                encodeURIComponent(String(guildId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const DefaultApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async addGuildMemberRole(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.addGuildMemberRole(
                guildId,
                userId,
                roleId,
                options,
        ...
        async deleteAutoModerationRule(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAutoModerationRule(
                guildId,
                ruleId,
                options,
            );
        ...
        async deleteGuildIntegration(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteGuildIntegration(
                guildId,
                integrationId,
                options,
            );
        ...
        async deleteGuildMemberRole(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteGuildMemberRole(
                guildId,
                userId,
                roleId,
                options,
        ...
        async deleteWebhookByToken(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteWebhookByToken(
                webhookId,
                webhookToken,
                options,
            );
        ...
        async followChannel(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.followChannel(
                channelId,
                followChannelRequest,
                options,
            );
        ...
        > {
            ...
            const operationBasePath =
                operationServerMap["DefaultApi.getApplicationRoleConnectionsMetadata"]?.[index]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        async getGuildApplicationCommandPermissions(
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath =
                operationServerMap["DefaultApi.getGuildApplicationCommandPermissions"]?.[index]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        async getGuildWebhooks(
            ...
            (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ListChannelWebhooks200ResponseInner>>
        > {
        ...
        async getThreadMember(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.getThreadMember(
                channelId,
                userId,
                withMember,
                options,
        ...
        async getWebhookByToken(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.getWebhookByToken(
                webhookId,
                webhookToken,
                options,
            );
        ...
        async listChannelInvites(
            ...
            (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ListChannelInvites200ResponseInner>>
        > {
        ...
        async listGuildApplicationCommandPermissions(
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath =
                operationServerMap["DefaultApi.listGuildApplicationCommandPermissions"]?.[index]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        async listGuildBans(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.listGuildBans(
                guildId,
                limit,
                before,
                after,
        ...
        async listGuildChannels(
            ...
            (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ListGuildChannels200ResponseInner>>
        > {
        ...
        async listGuildScheduledEvents(
            ...
            (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GetGuildScheduledEvent200Response>>
        > {
        ...
        async listMyGuilds(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.listMyGuilds(
                before,
                after,
                limit,
                withCounts,
        ...
        async previewPruneGuild(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.previewPruneGuild(
                guildId,
                days,
                includeRoles,
                options,
        ...
        async searchGuildMembers(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchGuildMembers(
                limit,
                query,
                guildId,
                options,
        ...
        async setGuildApplicationCommandPermissions(
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath =
                operationServerMap["DefaultApi.setGuildApplicationCommandPermissions"]?.[index]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        > {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath =
                operationServerMap["DefaultApi.updateApplicationRoleConnectionsMetadata"]?.[index]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        async updateApplicationUserRoleConnection(
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath =
                operationServerMap["DefaultApi.updateApplicationUserRoleConnection"]?.[index]?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
                    globalAxios,
        ...
        async updateGuild(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateGuild(
                guildId,
                guildPatchRequestPartial,
                options,
            );
        ...
        async updateMyApplication(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMyApplication(
                applicationFormPartial,
                options,
            );
            const index = configuration?.serverIndex ?? 0;
...
export interface DefaultApiInterface {
    ...
    getGuild(
        ...
        withCounts?: boolean,
        options?: RawAxiosRequestConfig,
    ): AxiosPromise<GuildWithCountsResponse>;
...
export class DefaultApi extends BaseAPI implements DefaultApiInterface {
     ...
     * @memberof DefaultApi
     */
    public getGuildApplicationCommand(
        applicationId: any,
        guildId: any,
        commandId: any,
        options?: RawAxiosRequestConfig,
     ...
     * @memberof DefaultApi
     */
    public listPrivateArchivedThreads(
        channelId: any,
        before?: string,
        limit?: number,
        options?: RawAxiosRequestConfig,
