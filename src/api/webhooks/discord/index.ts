...
import { type DiscordEnvironment, buildEventBus } from "./rabscuttle"
...
import { buildPeplicator } from "./commands/peplicator"
...
const buildDiscordEventBus = async (environment: DiscordEnvironment) => {
  ...
  const peplicator = await buildPeplicator(environment)
  eventBus.register(eightPepePlugin)
  eventBus.register(pepeThisPlugin)
  eventBus.register(peplicator)
