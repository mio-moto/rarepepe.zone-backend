...
export default async <const Prefix extends string | undefined>({ prefix = '/potd' }: { prefix: Prefix }, environment: Environment) => {
    ...
    return new Elysia({ prefix })
        ...
        .get(`/:year/:month/:day`, async ({ params: { year, month, day}, set }) => {
