  ...
  app
    ...
    .use(swagger({
      documentation: {
        tags: [
          ...
          { name: "randomizer", description: "Gacha your pepe, request one of a specific rarity - or just hit lucky" },
          { name: "hasher", description: "Hash a pepe deterministically - same phrases will always yield the same pepe" },
        ]
      }
    }))
    ...
    .get("/", ({ headers }) => {
      ...
      return JSON.stringify({
        ...
        "history": "This is a long term project of collecting Pepes all over the internet and sharing them.",
        "source": {
